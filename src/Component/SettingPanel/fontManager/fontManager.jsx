    ...
    <div className="layoutCreator">
      <div className="outerLayoutHeader">
        <div className="layoutCreatorHeader">
          <div className="layoutCreatorTitle">Fonts Manager</div>
          ...
          <FontPicker
            ...
            onChange={(nextFont) => {
              ...
              if (!fontOptions.fonts.includes(__new_font)) {
                setFontOptions({
                  ...fontOptions,
                  fonts: [...fontOptions.fonts, __new_font],
                });
              }
            }}
            sort={"popularity"}
      ...
      <div className="fontSelectorContent">
            ...
            return (
              <div className="fontOption">
                <div className="font_dets">
                  <span className="fontName" style={{ fontFamily: e.font }}>
                    {e.font}
                  </span>
                ...
                <div className="actionGroup">
                  {fontOptions.fonts.length > 1 && (
                    <button
                      className="deleteFont"
                      data-font-index={i}
                      onClick={deleteFontOption}
                    >
                      <i data-font-index={i} className="las la-trash-alt"></i>
                    </button>
                  )}
                </div>
              </div>
        ...
        <div className="footerStickyFontManager">
          <div className="webpageSpeed">
            <span style={fontSpeedColor()}>
              <i className="las la-tachometer-alt"></i> {"" + fontSpeed()}
            </span>
          </div>
