...
export default function RowWidth(props) {
  ...
  const applyRowWidth = () => {
    ...
    let __maxWidth = rowWidthState.fullRow
      ? `calc(100% - ${2 * rowWidthState.marginSide}px)`
      : rowWidthState.containerWidth + "px";
    ...
    let __margin = rowWidthState.fullRow
      ? "0px " + rowWidthState.marginSide + "px"
      : "0px auto";
  ...
  useEffect(() => {
    ...
    ClassTimer.current = setTimeout(() => {
      let node = document.querySelector(
        '[data-path="' + props.currentlyActive.current + ',"]'
      );
  ...
  const setValues = () => {
    ...
    if (
      ...
      node.style.maxWidth.indexOf("calc") >= 0
    ) {
  ...
  const showPrevWidth = () => {
    ...
    node.style.maxWidth = rowWidthState.fullRow
      ? `calc(100% - ${2 * rowWidthState.marginSide}px)`
      : rowWidthState.containerWidth + "px";
    // node.style.padding = (rowWidthState.fullRow) ? node.style.paddingTop + " " + rowWidthState.marginSide + "px" : node.style.paddingTop + " " + node.style.paddingLeft;
    node.style.margin = rowWidthState.fullRow
      ? "0px " + rowWidthState.marginSide + "px"
      : "0px auto";
  };
      ...
      <div className="rowWidth_Outer">
        <div className="rowWidth_inner">
          <div className="rowWidth_option">
            ...
            <div
              onClick={(e) => prevRowWidthFull(e, true)}
              className={
                rowWidthState.fullRow
            ...
            >
              ...
              <div className="scroll_name">Full</div>
            </div>
            <div
              onClick={(e) => prevRowWidthFull(e, false)}
              className={
                !rowWidthState.fullRow
                  ? "scrollOptionLink active"
                  : "scrollOptionLink"
            ...
            >
              ...
              <div className="scroll_name">Container</div>
            </div>
          </div>
          {rowWidthState.fullRow && (
            <div className="rowWidth_option">
              ...
              <div className="anim_slider_input" data-parentslide>
                <input
                  ...
                  max="200"
                  step="1"
                  value={rowWidthState.marginSide}
                  className="slider"
                />
            ...
            <div className="rowWidth_option">
              ...
              <div className="anim_slider_input" data-parentslide>
                <input
                  ...
                  max="1400"
                  step="10"
                  value={rowWidthState.containerWidth}
                  className="slider"
                />
